...
[ApiController]
[Authorize]
public class CoursesController(ICourseService<Course, CourseResponse, CourseRequest> courseService) : ControllerBase
{
    private readonly ICourseService<Course, CourseResponse, CourseRequest> _courseService = courseService;
    ...
    public async Task<IActionResult> Delete([FromRoute] int? Id, CancellationToken cancellationToken)
    {
        ...
        var courseResult = await _courseService.HardDeleteAsync(Id.Value, cancellationToken);
